...
public class ForumUserTestSuite {
    ...
    public void testUpdate(){
        ...
        ForumUser jessiePinkam = new ForumUser("Jessie Pinkam");
        javaHelpForum.registerObserver(johnSmith);
        javaToolsForum.registerObserver(ivoneEscobar);
        javaHelpForum.registerObserver(jessiePinkam);
        javaToolsForum.registerObserver(jessiePinkam);
        //When
        ...
        assertEquals(5,jessiePinkam.getUpdateCount());
    }
}
